...
// MAIN COMPONENT
// ------------------------------------------------------------ //
function __OriginkitBase_VaporizeTextCycle(props: VaporizeTextCycleProps = {}) {
...
export default function VaporizeTextCycle(props: Record<string, unknown>) {
    return <__OriginkitBase_VaporizeTextCycle {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
